...
class SurgeryViewHolder(val view: View, val clickListener: SurgeryAdapter.ClickListener) : RecyclerView.ViewHolder(view),
    ...
    lateinit var typeEntity: TypeSurgery

    fun bind(typeEntity: TypeSurgery, position: Int) {
