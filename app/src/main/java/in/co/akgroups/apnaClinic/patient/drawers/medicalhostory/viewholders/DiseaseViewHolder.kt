...
class DiseaseViewHolder(val view: View, val clickListener: DiseaseAdapter.ClickListener) : RecyclerView.ViewHolder(view),
    ...
    lateinit var typeEntity: TypeDiseases

    fun bind(typeEntity: TypeDiseases, position: Int) {
