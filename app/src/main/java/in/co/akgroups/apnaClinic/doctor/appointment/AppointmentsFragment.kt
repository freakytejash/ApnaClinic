...
class AppointmentsFragment : Fragment(), AppointmentContract.View {

    override lateinit var presenter: AppointmentContract.Presenter

    companion object {
        fun newInstance(bundle: Bundle): AppointmentsFragment {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var rootView = inflater.inflate(R.layout.layout_doctor_appointment, container, false)
